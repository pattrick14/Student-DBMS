...
def searchstudent():
    ...
    searchroot.resizable(True, True)
    # -----------------------------------Add studenmt Labels
...
def updatestudent():
    def update():
        ...
        strr = "update studentdata set name=%s,mobile=%s,email=%s,address=%s,gender=%s,dob=%s where id=%s" #,date=%s,time=%s
...
def Connectdb():
    def submitdb():
        ...
        try:
            ...
            mycursor.execute(strr)
            strr = 'create table studentdata (id int,name varchar(255),mobile varchar(15) ,email varchar(255) ,address varchar(255), gender varchar(10),dob varchar(10), dateofentry varchar(10), timeofentry varchar(10))'
            mycursor.execute(strr)
...
def IntroLabelTick():
    ...
    if (count >= len(ss)):
        ...
        SliderLabel.config(text=text)
        count+=1
    SliderLabel.after(200, IntroLabelTick)  # Set the delay between characters (in milliseconds)
...
root.resizable(True, True)  # dimensions cannot be changed
...
showbtn = Button(DataEntryFrame, text='5. Show All', width=25, font=('chiller', 20, 'bold'), bd=6, bg='skyblue3',
...
studenttable.heading('addeddate', text='addeddate')
studenttable.heading('addedtime', text='addedtime')
studenttable['show'] = 'headings'
studenttable.column('id', width=100)
studenttable.column('name', width=200)
studenttable.column('mobile', width=100)
...
studenttable.column('addeddate', width=150)
studenttable.column('addedtime', width=150)
